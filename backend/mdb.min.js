...
jQuery.extend(jQuery.easing, {
    ...
    easeInOutBack: function(t, e, i, n, a, r) {
        return void 0 == r && (r = 1.70158),
        (e /= a / 2) < 1 ? n / 2 * (e * e * ((1 + (r *= 1.525)) * e - r)) + i : n / 2 * ((e -= 2) * e * ((1 + (r *= 1.525)) * e + r) + 2) + i
    },
        ...
        i.extend = function() {
            ...
            l--); u > l; l++)
                if (null != (r = arguments[l]))
                    for (a in r)
                        t = s[a],
                        s !== (n = r[a]) && (d && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1,
                        o = t && i.isArray(t) ? t : []) : o = t && i.isPlainObject(t) ? t : {},
                        s[a] = i.extend(d, o, n)) : void 0 !== n && (s[a] = n));
            return s
        }
        ,
    ...
    return function(t, e, i, n) {
        ...
        function o(t, i, n, a) {
            ...
            var w = y ? new Float32Array(m) : new Array(m)
              ...
              , S = function(e) {
                return k || h(),
                t === i && n === a ? e : 0 === e ? 0 : 1 === e ? 1 : l(function(e) {
        ...
        function s(t, e) {
            ...
            .apply(null, t) : f.isArray(t) && 2 === t.length ? b.apply(null, t.concat([e])) : !(!f.isArray(t) || 4 !== t.length) && o.apply(null, t),
            !1 === i && (i = m.Easings[m.defaults.easing] ? m.defaults.easing : v),
            i
        }
        function l(t) {
            if (t) {
                    ...
                    if (m.State.calls[a]) {
                        ...
                        for (var v = Math.min((e - h) / c.duration, 1), b = 0, x = s.length; x > b; b++) {
                            ...
                            if (r(S)) {
                                ...
                                for (var M in c.visibility !== n && "hidden" !== c.visibility && y.setPropertyValue(S, "visibility", c.visibility),
                                k)
                                    if ("element" !== M) {
                                        var P, A = k[M], T = f.isString(A.easing) ? m.Easings[A.easing] : A.easing;
                                        if (1 === v)
                                            P = A.endValue;
                                        else {
                                            var I = A.endValue - A.startValue;
                                            if (P = A.startValue + I * T(v, c, I),
                                            !p && P === A.currentValue)
                                                continue
                                        }
                                        if (A.currentValue = P,
                                        "tween" === M)
                                            ...
                                            y.Hooks.registered[M] && (r(S).rootPropertyValueCache[_] = y.Normalizations.registered[_] ? y.Normalizations.registered[_]("extract", null, F[1]) : F[1]),
                                            "transform" === F[0] && (C = !0)
                                        }
                                    }
                                c.mobileHA && r(S).transformCache.translate3d === n && (r(S).transformCache.translate3d = "(0px, 0px, 0px)",
                                C = !0),
                                C && y.flushTransformCache(S)
                            }
                        }
                        c.display !== n && "none" !== c.display && (m.State.calls[a][2].display = !1),
                        c.visibility !== n && "hidden" !== c.visibility && (m.State.calls[a][2].visibility = !1),
                        c.progress && c.progress.call(o[1], o[1], v, Math.max(0, h + c.duration - e), h, g),
                        1 === v && u(a)
                    }
            }
        ...
        function u(t, e) {
            ...
            for (var i = m.State.calls[t][0], a = m.State.calls[t][1], o = m.State.calls[t][2], s = m.State.calls[t][4], l = !1, u = 0, c = i.length; c > u; u++) {
                var h = i[u].element;
                if (e || o.loop || ("none" === o.display && y.setPropertyValue(h, "display", o.display),
                "hidden" === o.visibility && y.setPropertyValue(h, "visibility", o.visibility)),
                !0 !== o.loop && (d.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(d.queue(h)[1])) && r(h)) {
                    r(h).isAnimating = !1,
        ...
        if (!(7 >= c)) {
            ...
            m.State.scrollPropertyTop = "pageYOffset") : (m.State.scrollAnchor = i.documentElement || i.body.parentNode || i.body,
            ...
            var b = function() {
                ...
                return function t(e, n, a) {
                    ...
                    l.tension = e,
                    l.friction = n,
                    (r = null !== a) ? o = (d = t(e, n)) / a * .016 : o = .016; s = i(s || l, o),
                    u.push(1 + s.x),
                    d += 16,
            ...
            var y = m.CSS = {
                            ...
                            !function() {
                                ...
                                y.Normalizations.registered[e] = function(t, i, a) {
                                    ...
                                    case "inject":
                                        ...
                                        case "scal":
                                        case "scale":
                                            m.State.isAndroid && r(i).transformCache[e] === n && 1 > a && (a = 1),
                                            o = !/(\d)$/i.test(a);
                                            break;
                                        case "skew":
                                            o = !/(deg|\d)$/i.test(a);
                                ...
                                y.Normalizations.registered[e] = function(t, i, a) {
                                    ...
                                    case "extract":
                                        ...
                                        if (y.RegEx.wrappedValueAlreadyExtracted.test(a))
                                            ...
                                            /^[A-z]+$/i.test(a) ? o = s[a] !== n ? s[a] : s.black : y.RegEx.isHex.test(a) ? o = "rgb(" + y.Values.hexToRgb(a).join(" ") + ")" : /^rgba?\(/i.test(a) || (o = s.black),
                                            r = (o || a).toString().match(y.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                        }
                                        return 8 >= c || 3 !== r.split(" ").length || (r += " 1"),
                                        r;
                                    case "inject":
                                        return 8 >= c ? 4 === a.split(" ").length && (a = a.split(/\s+/).slice(0, 3).join(" ")) : 3 === a.split(" ").length && (a += " 1"),
                                        (8 >= c ? "rgb" : "rgba") + "(" + a.replace(/\s+/g, ",").replace(/\.(\d)+(?=,)/g, "") + ")"
                                    }
                                }
                            }()
                    }
                ...
                Names: {
                    ...
                    SVGAttribute: function(t) {
                        ...
                        return (c || m.State.isAndroid && !m.State.isChrome) && (e += "|transform"),
                    ...
                    prefixCheck: function(t) {
                        ...
                        for (var e = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = e.length; n > i; i++) {
                            ...
                            f.isString(m.State.prefixElement.style[a]))
                                return m.State.prefixMatches[t] = a,
                                [a, !0]
                        }
                        return [t, !1]
                    }
                ...
                getPropertyValue: function(t, i, a, o) {
                    function s(t, i) {
                        ...
                        if (8 >= c)
                            ...
                            var u, h = !1;
                            if (/^(width|height)$/.test(i) && 0 === y.getPropertyValue(t, "display") && (h = !0,
                            y.setPropertyValue(t, "display", y.Values.getDisplayType(t))),
                            !o) {
                            ...
                            u = r(t) === n ? e.getComputedStyle(t, null) : r(t).computedStyle ? r(t).computedStyle : r(t).computedStyle = e.getComputedStyle(t, null),
                            "borderColor" === i && (i = "borderTopColor"),
                            ("" === (l = 9 === c && "filter" === i ? u.getPropertyValue(i) : u[i]) || null === l) && (l = t.style[i]),
                            a()
                        }
                    ...
                    if (y.Hooks.registered[i]) {
                        ...
                        var f, p;
                        "transform" !== (f = y.Normalizations.registered[i]("name", t)) && (p = s(t, y.Names.prefixCheck(f)[0]),
                        y.Values.isCSSNullValue(p) && y.Hooks.templates[i] && (p = y.Hooks.templates[i][1])),
                ...
                setPropertyValue: function(t, i, n, a, o) {
                    ...
                    if ("scroll" === i)
                        ...
                        if (y.Normalizations.registered[i] && (n = y.Normalizations.registered[i]("inject", t, n),
                ...
                flushTransformCache: function(t) {
                    ...
                    if ((c || m.State.isAndroid && !m.State.isChrome) && r(t).isSVG) {
                        ...
                        d.each(r(t).transformCache, function(e) {
                            ...
                            "transformPerspective" === e ? (o = a,
                            !0) : (9 === c && "rotateZ" === e && (e = "rotate"),
                            void (i += e + a + " "))
                        }),
                        o && (i = "perspective" + o + " " + i)
                    }
            ...
            var x = function() {
                ...
                function o() {
                    function t(t) {
                        function h(t, e) {
                            ...
                            !f.isArray(t[1]) && /^[\d-]/.test(t[1]) || f.isFunction(t[1]) || y.RegEx.isHex.test(t[1]) ? r = t[1] : (f.isString(t[1]) && !y.RegEx.isHex.test(t[1]) || f.isArray(t[1])) && (a = e ? t[1] : s(t[1], u.duration),
                            t[2] !== n && (r = t[2]))) : i = t,
                            e || (a = a || u.easing),
                        ...
                        function g() {
                            ...
                            l.vwToPx = L.vwToPx,
                            l.vhToPx = L.vhToPx,
                            m.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), o),
                            l
                        }
                        if (u.begin && 0 === C)
                            try {
                        ...
                        if ("scroll" === P) {
                            var x, k, M, T = /^x$/i.test(u.axis) ? "Left" : "Top", I = parseFloat(u.offset) || 0;
                            u.container ? f.isWrapped(u.container) || f.isNode(u.container) ? (u.container = u.container[0] || u.container,
                            M = (x = u.container["scroll" + T]) + d(o).position()[T.toLowerCase()] + I) : u.container = null : (x = m.State.scrollAnchor[m.State["scrollProperty" + T]],
                            k = m.State.scrollAnchor[m.State["scrollProperty" + ("Left" === T ? "Top" : "Left")]],
                            ...
                            for (var D in _)
                                if ("element" !== D) {
                                    ...
                                    m.debug && console.log("reverse tweensContainer (" + D + "): " + JSON.stringify(_[D]), o)
                                }
                            c = _
                        } else if ("start" === P) {
                            for (var O in r(o).tweensContainer && !0 === r(o).isAnimating && (_ = r(o).tweensContainer),
                            ...
                            b) {
                                ...
                                if (r(o).isSVG || "tween" === E || !1 !== y.Names.prefixCheck(E)[1] || y.Normalizations.registered[E] !== n) {
                                    (u.display !== n && null !== u.display && "none" !== u.display || u.visibility !== n && "hidden" !== u.visibility) && /opacity|filter/.test(O) && !B && 0 !== z && (B = 0),
                                    u._cacheValues && _ && _[O] ? (B === n && (B = _[O].endValue + _[O].unitType),
                                    W = r(o).rootPropertyValueCache[E]) : y.Hooks.registered[O] ? B === n ? (W = y.getPropertyValue(o, E),
                                    B = y.getPropertyValue(o, O, W)) : W = y.Hooks.templates[E][1] : B === n && (B = y.getPropertyValue(o, O));
                                    var H, j, q, Y = !1;
                                    if (B = (H = p(O, B))[0],
                                    q = H[1],
                                    ...
                                    B = parseFloat(B) || 0,
                                    z = parseFloat(z) || 0,
                                    "%" === j && (/^(fontSize|lineHeight)$/.test(O) ? (z /= 100,
                                    j = "em") : /^scale/.test(O) ? (z /= 100,
                                    j = "") : /(Red|Green|Blue)$/i.test(O) && (z = z / 100 * 255,
                                    j = "")),
                                    /[\/*]/.test(Y))
                                        j = q;
                                    else if (q !== j && 0 !== B)
                                    ...
                                    m.debug && console.log("Skipping [" + E + "] due to a lack of browser support.")
                            }
                            c.element = o
                        }
                        c.element && (y.Values.addClass(o, "velocity-animating"),
                        R.push(c),
                        "" === u.queue && (r(o).tweensContainer = c,
                        r(o).opts = u),
                        r(o).isAnimating = !0,
                        C === S - 1 ? (m.State.calls.push([R, v, u, null, A.resolver]),
                        !1 === m.State.isTicking && (m.State.isTicking = !0,
                        l())) : C++)
                    }
                    var a, o = this, u = d.extend({}, m.defaults, w), c = {};
                    switch (r(o) === n && m.init(o),
                    parseFloat(u.delay) && !1 !== u.queue && d.queue(o, u.queue, function(t) {
                    ...
                    !1 !== m.mock && (!0 === m.mock ? u.duration = u.delay = 1 : (u.duration *= parseFloat(m.mock) || 1,
                    ...
                    u.display !== n && null !== u.display && (u.display = u.display.toString().toLowerCase(),
                    "auto" === u.display && (u.display = m.CSS.Values.getDisplayType(o))),
                    ...
                    !1 === u.queue ? u.delay ? setTimeout(t, u.delay) : t() : d.queue(o, u.queue, function(e, i) {
                        return !0 === i ? (A.promise && A.resolver(v),
                        !0) : (m.velocityQueueEntryFlag = !0,
                        void t())
                    }),
                ...
                v = a(v)) {
                    k ? (b = arguments[0].properties || arguments[0].p,
                    w = arguments[0].options || arguments[0].o) : (b = arguments[p],
                    w = arguments[p + 1]);
                    var S = v.length
                      , C = 0;
                        ...
                        return d.each(m.State.calls, function(t, e) {
                            e && d.each(e[1], function(i, a) {
                                ...
                                return !0 !== o && e[2].queue !== o && (w !== n || !1 !== e[2].queue) || void d.each(v, function(i, n) {
                                    ...
                                    "stop" === b ? (r(n) && r(n).tweensContainer && !1 !== o && d.each(r(n).tweensContainer, function(t, e) {
                        ...
                        if (!d.isPlainObject(b) || f.isEmptyObject(b)) {
                            if (f.isString(b) && m.Redirects[b]) {
                                var I = (O = d.extend({}, w)).duration
                                  , _ = O.delay || 0;
                                return !0 === O.backwards && (v = d.extend(!0, [], v).reverse()),
                                d.each(v, function(t, e) {
                                    parseFloat(O.stagger) ? O.delay = _ + parseFloat(O.stagger) * t : f.isFunction(O.stagger) && (O.delay = _ + O.stagger.call(e, t, S)),
                                    O.drag && (O.duration = parseFloat(I) || (/^(callout|transition)/.test(b) ? 1e3 : g),
                                    O.duration = Math.max(O.duration * (O.backwards ? 1 - t / S : (t + 1) / S), .75 * O.duration, 200)),
                                    m.Redirects[b].call(e, e, O || {}, t, S, v, A.promise ? A : n)
                                }),
                                t()
                            }
                            var D = "Velocity: First argument (" + b + ") was not a property map, a known action, or a registered redirect. Aborting.";
                            return A.promise ? A.rejecter(new Error(D)) : console.log(D),
                            t()
                        }
                        P = "start"
                    }
...
function(t) {
    ...
    return function() {
            ...
            e.exports = function(t) {
                t.controllers.bar = t.DatasetController.extend({
                    ...
                    calculateBarValuePixels: function(t, e) {
                        var i, n, a, r, o, s, l = this.chart, u = this.getMeta(), d = this.getValueScale(), c = l.data.datasets, h = d.getRightValue(c[t].data[e]), f = d.options.stacked, p = u.stack, g = 0;
                        if (f || void 0 === f && void 0 !== p)
                            for (i = 0; i < t; ++i)
                                (n = l.getDatasetMeta(i)).bar && n.stack === p && n.controller.getValueScaleId() === d.id && l.isDatasetVisible(i) && (a = d.getRightValue(c[i].data[e]),
                                (h < 0 && a < 0 || h >= 0 && a > 0) && (g += a));
                    ...
                    calculateBarIndexPixels: function(t, e, i) {
                        var n = i.scale.options
                          , a = "flex" === n.barThickness ? function(t, e, i) {
                            ...
                            return null === o && (o = r - (null === s ? e.end - r : s - r)),
                            null === s && (s = r + r - o),
                            n = r - (r - o) / 2 * l,
                            {
                            ...
                            return r.isNullOrUndef(o) ? (n = e.min * i.categoryPercentage,
                            a = i.barPercentage) : (n = o * s,
                            a = 1),
                            {
                                chunk: n / s,
                                ratio: a,
            ...
            e.exports = function(t) {
                t.controllers.bubble = t.DatasetController.extend({
                    ...
                    _resolveElementOptions: function(t, e) {
                        var i, n, a, o = this.chart, s = o.data.datasets[this.index], l = t.custom || {}, u = o.options.elements.point, d = r.options.resolve, c = s.data[e], h = {}, f = {
                            chart: o,
                            dataIndex: e,
                            dataset: s,
        ...
        18: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                t.controllers.line = t.DatasetController.extend({
                    ...
                    dataElementType: a.Point,
                    update: function(t) {
                        var i, n, a, o = this, s = o.getMeta(), l = s.dataset, u = s.data || [], d = o.chart.options, c = d.elements.line, h = o.getScaleForId(s.yAxisID), f = o.getDataset(), p = e(f, d);
                        for (p && (a = l.custom || {},
                    ...
                    updateElement: function(t, e, i) {
                        var n, a, o = this, s = o.getMeta(), l = t.custom || {}, u = o.getDataset(), d = o.index, c = u.data[e], h = o.getScaleForId(s.yAxisID), f = o.getScaleForId(s.xAxisID), p = o.chart.options.elements.point;
                ...
                a.extend(t.prototype, {
                    construct: function(e, i) {
                        ...
                        i = function(t) {
                            ...
                            e.labels = e.labels || [],
                            t.options = a.configMerge(n.global, n[t.type], t.options || {}),
                            t
                        }(i);
                ...
                update: function(t, e, i) {
                    if (t) {
                        ...
                        n.each(h.concat(f, p, g), function(t) {
                            ...
                            i ? (e = t.update(t.fullWidth ? m : k, w),
                    ...
                    function E(t) {
                        t.isHorizontal() ? (t.left = t.fullWidth ? l : I,
            ...
            e.exports = function(t) {
                ...
                t.Scale = a.extend({
                    ...
                    fit: function() {
                        ...
                        if (n.width = f ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : h && c.drawTicks ? g : 0,
                        ...
                        if (u.display && h) {
                            ...
                            if (f) {
                                ...
                                0 !== t.labelRotation ? (t.paddingLeft = "bottom" === l.position ? k * C + 3 : k * y + 3,
                                t.paddingRight = "bottom" === l.position ? k * y + 3 : k * M + 3) : (t.paddingLeft = C / 2 + 3,
                    ...
                    _autoSkip: function(t) {
                        var e, i, n, a, o = this, s = o.isHorizontal(), l = o.options.ticks.minor, u = t.length, d = r.toRadians(o.labelRotation), c = Math.cos(d), h = o.longestLabelWidth * c, f = [];
                        for (l.maxTicksLimit && (a = l.maxTicksLimit),
                        s && (e = !1,
                        (h + l.autoSkipPadding) * u > o.width - (o.paddingLeft + o.paddingRight) && (e = 1 + Math.floor((h + l.autoSkipPadding) * u / (o.width - (o.paddingLeft + o.paddingRight)))),
                        ...
                        if (a.display) {
                            ...
                            if (r.each(v, function(i, n) {
                                if (!r.isNullOrUndef(i.label)) {
                                    var o, s, c, f, m, b, y, x, k, S, C, F, O, L, R = i.label;
                                    n === e.zeroLineIndex && a.offset === h.offsetGridLines ? (o = h.zeroLineWidth,
                                    s = h.zeroLineColor,
                                    c = h.zeroLineBorderDash,
                                    f = h.zeroLineBorderDashOffset) : (o = r.valueAtIndexOrDefault(h.lineWidth, n),
                                    s = r.valueAtIndexOrDefault(h.color, n),
                                    c = r.valueOrDefault(h.borderDash, u.borderDash),
                                    f = r.valueOrDefault(h.borderDashOffset, u.borderDashOffset));
                                    var V = "middle"
                                      , z = "middle"
                                      , N = d.padding;
                                    if (g) {
                                        var B = w + N;
                                        "bottom" === a.position ? (z = p ? "middle" : "top",
                                        V = p ? "right" : "center",
                                        L = e.top + B) : (z = p ? "middle" : "bottom",
                                        V = p ? "left" : "center",
                                        L = e.bottom - B);
                                        var E = l(e, n, h.offsetGridLines && v.length > 1);
                                        ...
                                        d.mirror ? (V = H ? "left" : "right",
                                        W = N) : (V = H ? "right" : "left",
                                        W = w + N),
                                        O = H ? e.right - W : e.left + W;
                                        var j = l(e, n, h.offsetGridLines && v.length > 1);
                            ...
                            r.each(P, function(t) {
                                ...
                                d.display) {
                                    ...
                                    var i = t.label;
                                    if (r.isArray(i))
                                        for (var n = i.length, a = 1.5 * b.size, o = e.isHorizontal() ? 0 : -a * (n - 1) / 2, l = 0; l < n; ++l)
                                            s.fillText("" + i[l], 0, o),
                                            o += a;
                                    else
                                        s.fillText(i, 0, 0);
                            ...
                            if (h.drawBorder) {
                                ...
                                g ? (B = E = "top" === a.position ? e.bottom : e.top,
                                B += W,
                                E += W) : (z = N = "left" === a.position ? e.right : e.left,
                                z += W,
                                N += W),
                                s.beginPath(),
                                s.moveTo(z, B),
        ...
        35: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                t.Tooltip = a.extend({
                    ...
                    update: function(e) {
                        var i, n, a, s, l, u, d, c = this, h = c._options, f = c._model, p = c._model = o(h), g = c._active, v = c._data, m = {
                            xAlign: f.xAlign,
                            yAlign: f.yAlign
                        }, b = {
                            x: f.x,
                        ...
                        if (g.length) {
                            ...
                            b = function(t, e, i, n) {
                                ...
                                a < 0 && (a = 0)),
                                "top" === d ? r += c : r -= "bottom" === d ? e.height + c : e.height / 2,
                                "center" === d ? "left" === u ? a += c : "right" === u && (a -= c) : "left" === u ? a -= h : "right" === u && (a += h),
                                {
                                    x: a,
                                    y: r
                                }
                                ...
                                var i, n, a, r, o, s = t._model, l = t._chart, u = t._chart.chartArea, d = "center", c = "center";
                    ...
                    getCaretPosition: function(t, e, i) {
                        var n, a, r, o, s, l, u = i.caretSize, d = i.cornerRadius, c = i.xAlign, h = i.yAlign, f = t.x, p = t.y, g = e.width, v = e.height;
                        if ("center" === h)
                            s = p + v / 2,
                            "left" === c ? (a = (n = f) - u,
                            r = n,
        ...
        37: [function(t, e, i) {
            ...
            e.exports = a.extend({
                draw: function() {
                    var t, e, i, n, a = this._view, s = this._chart.ctx, l = a.spanGaps, u = this._children.slice(), d = o.elements.line, c = -1;
                    ...
                    t = 0; t < u.length; ++t)
                        ...
                        c = t) : (i = -1 === c ? i : u[c],
                        n.skip || (c !== t - 1 && !l || -1 === c ? s.moveTo(n.x, n.y) : r.canvas.lineTo(s, i._view, e._view),
                        c = t));
                    s.stroke(),
                    s.restore()
                }
        ...
        47: [function(t, e, i) {
            ...
            function g(t, e, i) {
                var u, d, c, f, g = t[a] || (t[a] = {}), v = g.resizer = function(t) {
            ...
            e.exports = {
                ...
                beforeDatasetDraw: function(t, e) {
                    ...
                    if (i) {
                        ...
                        u && d && l.length && (r.canvas.clipArea(a, t.chartArea),
                        function(t, e, i, n, a, r) {
                            var o, s, l, u, d, f, p, g = e.length, v = n.spanGaps, m = [], b = [], y = 0, x = 0;
                            for (t.beginPath(),
                            o = 0,
                            s = g + !!r; o < s; ++o)
                                ...
                                p = c(d),
                                f && p ? (y = m.push(u),
                                x = b.push(d)) : y && x && (v ? (f && m.push(u),
                                p && b.push(d)) : (h(t, m, b, y, x),
                                y = x = 0,
                                m = [],
                                b = []));
                            h(t, m, b, y, x),
            ...
            var u = a.extend({
                ...
                fit: function() {
                    var t = this
                      ...
                      , g = t.minSize
                      , v = t.isHorizontal();
                    if (v ? (g.width = t.maxWidth,
                    g.height = a ? 10 : 0) : (g.width = a ? 10 : 0,
                    ...
                    a)
                        ...
                        v) {
                            ...
                            r.each(t.legendItems, function(e, n) {
                                ...
                                m[m.length - 1] + a + i.padding >= t.width && (b += d + i.padding,
                                m[m.length] = t.left),
                                p[n] = {
                                    left: 0,
                                    top: 0,
                ...
                draw: function() {
                    var t = this
                      ...
                      , u = t.lineWidths;
                    if (e.display) {
                        var d, c = t.ctx, h = r.valueOrDefault, f = h(i.fontColor, a.defaultFontColor), p = h(i.fontSize, a.defaultFontSize), g = h(i.fontStyle, a.defaultFontStyle), v = h(i.fontFamily, a.defaultFontFamily), m = r.fontString(p, g, v);
                        c.textAlign = "left",
                        ...
                        r.each(t.legendItems, function(n, l) {
                            ...
                            x ? v + g >= s && (m = d.y += w,
                            d.line++,
                            v = d.x = t.left + (s - u[d.line]) / 2) : m + w > t.bottom && (v = d.x = v + t.columnWidths[d.line] + i.padding,
                            ...
                            function(t, i, n) {
                                if (!(isNaN(b) || b <= 0)) {
                                    ...
                                    if (c.setLineDash && c.setLineDash(h(n.lineDash, o.borderDash)),
            ...
            var l = a.extend({
                ...
                draw: function() {
                    var t = this
                      ...
                      , o = n.global;
                    if (a.display) {
                        var s, l, u, d = i(a.fontSize, o.defaultFontSize), c = i(a.fontStyle, o.defaultFontStyle), h = i(a.fontFamily, o.defaultFontFamily), f = r.fontString(d, c, h), p = r.options.toLineHeight(a.lineHeight, d), g = p / 2 + a.padding, v = 0, m = t.top, b = t.left, y = t.bottom, x = t.right;
                        e.fillStyle = i(a.fontColor, o.defaultFontColor),
                        e.font = f,
                        t.isHorizontal() ? (l = b + (x - b) / 2,
                        u = m + g,
                        s = x - b) : (l = "left" === a.position ? b + g : x - g,
                        u = m + (y - m) / 2,
                        s = y - m,
                ...
                var e = {
                  ...
                  , i = t.Scale.extend({
                    ...
                    getPixelForValue: function(e) {
                        var i, a, r, o, s, l = this, u = l.options.ticks.reverse, d = n.log10, c = l._getFirstTickValue(l.minNotZero), h = 0;
                        ...
                        s *= -1,
                        a = u ? l.top : l.bottom),
                        e !== r && (0 === r && (i -= h = n.getValueOrDefault(l.options.ticks.fontSize, t.defaults.global.defaultFontSize),
                        r = c),
                                ...
                                if (s > 0 || r.reverse) {
                                    ...
                                    r.display) {
                                        ...
                                        r.showLabelBackdrop) {
                                            ...
                                            h.fillRect(-c / 2 - r.backdropPaddingX, -u - p / 2 - r.backdropPaddingY, c + 2 * r.backdropPaddingX, p + 2 * r.backdropPaddingY)
                                        }
                                        h.textAlign = "center",
                                ...
                                for (var p = o(t) - 1; p >= 0; p--) {
                                    ...
                                    if (l.display) {
                                        var v = t.getPointPosition(p, h + 5)
                                          , m = a.valueAtIndexOrDefault(l.fontColor, p, e.defaultFontColor);
                                        i.font = f.font,
                                        i.fillStyle = m;
        ...
        58: [function(t, e, i) {
            ...
            function v(t, e, i, a) {
                var o, d = a.time, c = d.unit || function(t, e, i, n) {
                    ...
                    for (a = u.indexOf(t); a < d - 1; ++a)
                        ...
                        r.common && Math.ceil((i - e) / (o * r.size)) <= n)
                            return u[a];
                    return u[d - 1]
                }(d.minUnit, t, e, i), h = g(c), f = r.valueOrDefault(d.stepSize, d.unitStepSize), p = "week" === c && d.isoWeekday, v = a.ticks.major.enabled, m = l[c], b = n(t), y = n(e), x = [];
                for (f || (f = function(t, e, i, n) {
                    var a, r, o, s = e - t, u = l[i], d = u.size, c = u.steps;
                    if (!c)
                        return Math.ceil(s / (n * d));
                    for (a = 0,
                    r = c.length; a < r && (o = c[a],
                    !(Math.ceil(s / (d * o)) <= n)); ++a)
                        ;
                    return o
                }(t, e, c, i)),
                ...
                o = n(b),
                v && h && !p && !d.round && (o.startOf(h),
                o.add(~~((b - o) / (m.size * f)) * f, c)); o < y; o.add(f, c))
                    x.push(+o);
                return x.push(+o),
                x
            }
            e.exports = function(t) {
                var e = t.Scale.extend({
                    ...
                    determineDataLimits: function() {
                        var t, e, i, a, l, u, h = this, f = h.chart, g = h.options.time, v = g.unit || "day", m = s, b = o, y = [], x = [], w = [];
                        for (t = 0,
                        ...
                        i = (f.data.datasets || []).length; t < i; ++t)
                            if (f.isDatasetVisible(t))
                                ...
                                x[t] = [];
                        w.length && (w = c(w).sort(d),
                        m = Math.min(m, w[0]),
                        b = Math.max(b, w[w.length - 1])),
                        y.length && (y = c(y).sort(d),
                        m = Math.min(m, y[0]),
                    ...
                    buildTicks: function() {
                        var t, e, i, a = this, r = a.min, o = a.max, s = a.options, d = s.time, c = [], m = [];
                        ...
                        for ("ticks" === s.bounds && c.length && (r = c[0],
                        o = c[c.length - 1]),
                        r = p(d.min, a) || r,
                        o = p(d.max, a) || o,
                        t = 0,
                        ...
                        return a.min = r,
                        a.max = o,
                        a._unit = d.unit || function(t, e, i, a) {
                        ...
                        a._offsets = function(t, e, i, n, a) {
                            var r, o, s = 0, l = 0;
                            return a.offset && e.length && (a.time.min || (r = e.length > 1 ? e[1] : n,
                            o = e[0],
                            s = (h(t, "time", r, "pos") - h(t, "time", o, "pos")) / 2),
                            a.time.max || (r = e[e.length - 1],
                            o = e.length > 1 ? e[e.length - 2] : i,
                            l = (h(t, "time", r, "pos") - h(t, "time", o, "pos")) / 2)),
                            {
                                left: s,
                                right: l
                            }
    ...
    var l = {
        ...
        show: function(t, e, i) {
            ...
            var a = o(e)
              , r = 0
              , u = 0;
            "touches"in t && t.touches.length ? (r = t.touches[0].pageY - a.top,
            u = t.touches[0].pageX - a.left) : (r = t.pageY - a.top,
            u = t.pageX - a.left),
            u = u >= 0 ? u : 0,
            r = r >= 0 ? r : 0;
...
function(t) {
    ...
    t(document).on("blur", e, function(e) {
        ...
        a && r && o && i.siblings("label, i").removeClass("active"),
        n(i)
    }),
    ...
    function() {
        ...
        if (e.length) {
            var i = void 0;
            i = window.attachEvent ? function(t, e, i) {
